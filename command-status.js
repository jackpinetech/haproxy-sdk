...
class CommandStatus {
   ...
   */
  static get SUCCESS_OUTPUT_STRINGS() {
    return ["Done.", ""];
  }

  static get ERROR_OUTPUT_STRINGS() {
    return [
  ...
  static get SUCCESS_STRING_ADDRESS() {
    return "IP changed from|no need to change the addr";
  }

  static get SUCCESS_STRING_PORT() {
    return "no need to change the addr, port changed from|no need to change the addr, no need to change the port";
  }
}
